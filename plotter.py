...
# this file incorporates plotting with loading
# i will separate these functionalities in recent.py
# this is so multiple TDMS files can be loaded before plotting
